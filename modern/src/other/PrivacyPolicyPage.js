    ...
    <div data-custom-class="body">
          ...
          <strong>
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="subtitle">
                Last updated
                {' '}
                <bdt className="question">February 05, 2023</bdt>
              </span>
            </span>
          </strong>
        </span>
          ...
          <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
              <span data-custom-class="body_text">
                ...
                at
                {' '}
                <bdt className="question">missa.ezyy.cloud</bdt>
                <span style={{ fontSize: '15px' }}>
                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                    <span data-custom-class="body_text">
                      <span style={{ fontSize: '15px' }}>
        ...
        <span style={{ fontSize: '15px' }}>
          <span style={{ color: 'rgb(127, 127, 127)' }}>
            <span data-custom-class="body_text">
              ...
              {' '}
              <bdt className="question">wecare@ezyy.cloud</bdt>
              .
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span style={{ fontSize: '15px' }}>
          <span data-custom-class="body_text">
            ...
            {' '}
            <bdt className="block-component" />
            <bdt className="question">Ezyy Cloud</bdt>
            <bdt className="statement-end-if-in-editor" />
            {' '}
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a
          ...
          href="https://app.termly.io/notify/1f74ad6a-eacc-4108-bb3a-12b4dca2291d"
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span data-custom-class="body_text">
          <span style={{ fontSize: '15px' }}>
            ...
            {' '}
            If you use our application(s), we
        ...
        <li style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              {' '}
              <bdt className="forloop-component" />
              <bdt className="question">sensors</bdt>
              ,
              {' '}
              <bdt className="forloop-component" />
          ...
          <li style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="body_text">
                ...
                {' '}
                We may request to send you push
            ...
            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  <em>Device Data.</em>
                  {' '}
                  We collect device data such as
